...
import 'package:task_board/main.dart'; // Adjust the import path according to your package structure

void main() {
  testWidgets('Welcome page to TaskBoardPage transition test', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    // Build our app and trigger a frame.
    await tester.pumpWidget(TaskBoardApp()); // Remove the const keyword
